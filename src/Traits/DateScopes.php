...
trait DateScopes
{
    ...
    // START SECONDS
    public function scopeOfJustNow(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastSeconds(1, $startFrom, DateRange::INCLUSIVE);
    }

    public function scopeOfLastSecond(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastSeconds(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast15Seconds(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastSeconds(15, $startFrom, $customRange);
    }

    public function scopeOfLast30Seconds(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastSeconds(30, $startFrom, $customRange);
    }

    public function scopeOfLast45Seconds(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastSeconds(45, $startFrom, $customRange);
    }

    public function scopeOfLast60Seconds(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastSeconds(60, $startFrom, $customRange);
    }
    ...
    // START MINUTES
    public function scopeOfLastMinute(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastMinutes(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast15Minutes(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMinutes(15, $startFrom, $customRange);
    }

    public function scopeOfLast30Minutes(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMinutes(30, $startFrom, $customRange);
    }

    public function scopeOfLast45Minutes(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMinutes(45, $startFrom, $customRange);
    }

    public function scopeOfLast60Minutes(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMinutes(60, $startFrom, $customRange);
    }
    ...
    // START HOURS
    public function scopeOfLastHour(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastHours(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast6Hours(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastHours(6, $startFrom, $customRange);
    }

    public function scopeOfLast12Hours(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastHours(12, $startFrom, $customRange);
    }

    public function scopeOfLast18Hours(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastHours(18, $startFrom, $customRange);
    }

    public function scopeOfLast24Hours(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastHours(24, $startFrom, $customRange);
    }
    ...
    // START DAYS
    public function scopeOfToday(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastDays(1, $startFrom, DateRange::INCLUSIVE);
    }

    public function scopeOfYesterday(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastDays(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast7Days(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastDays(7, $startFrom, $customRange);
    }

    public function scopeOfLast14Days(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastDays(14, $startFrom, $customRange);
    }

    public function scopeOfLast21Days(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastDays(21, $startFrom, $customRange);
    }

    public function scopeOfLast30Days(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastDays(30, $startFrom, $customRange);
    }
    ...
    // START WEEKS
    public function scopeOfLastWeek(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastWeeks(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast2Weeks(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastWeeks(2, $startFrom, $customRange);
    }

    public function scopeOfLast3Weeks(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastWeeks(3, $startFrom, $customRange);
    }

    public function scopeOfLast4Weeks(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastWeeks(4, $startFrom, $customRange);
    }
    ...
    // START MONTHS
    public function scopeOfLastMonth(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastMonths(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast3Months(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMonths(3, $startFrom, $customRange);
    }

    public function scopeOfLast6Months(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMonths(6, $startFrom, $customRange);
    }

    public function scopeOfLast9Months(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMonths(9, $startFrom, $customRange);
    }

    public function scopeOfLast12Months(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastMonths(12, $startFrom, $customRange);
    }
    ...
    // START QUARTER
    public function scopeOfLastQuarter(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastQuarters(1, $startFrom, DateRange::EXCLUSIVE);
    }

    public function scopeOfLast2Quarters(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastQuarters(2, $startFrom, $customRange);
    }

    public function scopeOfLast3Quarters(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastQuarters(3, $startFrom, $customRange);
    }

    public function scopeOfLast4Quarters(Builder $query, $startFrom = null, ?DateRange $customRange = null): Builder
    {
        return $query->ofLastQuarters(4, $startFrom, $customRange);
    }
    ...
    // START YEARS
    public function scopeOfLastYear(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastYears(1, $startFrom, DateRange::EXCLUSIVE);
    }
    ...
    // START DECADE
    public function scopeOfLastDecade(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastDecades(1, $startFrom, DateRange::EXCLUSIVE);
    }
    ...
    // START CENTURIES
    public function scopeOfLastCentury(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastCenturies(1, $startFrom, DateRange::EXCLUSIVE);
    }
    ...
    // START MILLENNIUM
    public function scopeOfLastMillennium(Builder $query, $startFrom = null): Builder
    {
        return $query->ofLastMillenniums(1, $startFrom, DateRange::EXCLUSIVE);
    }
    ...
    {
        return $query->ofLastSeconds(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeMinuteToNow(Builder $query): Builder
    {
        return $query->ofLastMinutes(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeHourToNow(Builder $query): Builder
    {
        return $query->ofLastHours(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeDayToNow(Builder $query): Builder
    {
        return $query->ofLastDays(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeWeekToDate(Builder $query): Builder
    {
        return $query->ofLastWeeks(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeMonthToDate(Builder $query): Builder
    {
        return $query->ofLastMonths(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeQuarterToDate(Builder $query): Builder
    {
        return $query->ofLastQuarters(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeYearToDate(Builder $query): Builder
    {
        return $query->ofLastYears(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeDecadeToDate(Builder $query): Builder
    {
        return $query->ofLastDecades(1, customRange: DateRange::INCLUSIVE);
    }

    public function scopeCenturyToDate(Builder $query): Builder
    {
        return $query->ofLastCenturies(1, customRange: DateRange::INCLUSIVE);
    }
